...
class HomeViewController: UIViewController {
    ...
    private func setupUI() {
        ...
        mapView.heightAnchor.constraint(equalToConstant: view.bounds.size.height / 2)
            .isActive = true
        ...
        recentsView.widthAnchor.constraint(equalToConstant: view.bounds.size.width / 1.2)
            .isActive = true
        ...
        restaurantsView.heightAnchor
            .constraint(equalToConstant: view.bounds.size.height / 2 + view.safeAreaInsets.top)
            .isActive = true
